class CoffeeMachine:
    ...
    def take(self): # for paying the amount
        ...
        dollars=int(input("enter the number of dollars")) #for calculating quarters
        cents=int(input("enter the number of cents"))       #for calculating dimes
        amt=dollars+cents      
        ...
        if(amt==self.reduced[4]):
            ...
            if(amt>self.reduced[4]):
               ...
               if(dollars+cents==self.reduced[4]-amt):
                   print("yay!Order confirmed.")
...
CoffeeMachine(500, 540, 50, 10, 500) # specify the quantities of supplies at the beginning
